...
| Sources ever re-checked | **15 of 299.** Nine figure-source documents are now re-read; two of the eleven figure-source documents remain first-read only |
...
2. **A published recheck cadence.** 284 of 299 sources have
   ...
   overstate itself. Two dated-figure sources remain in the first-read queue.
...
3. **Finish the figure-source recheck.** Needs a session that can reach the
   documents; see the egress note in section 4. 9 of 11 are now rechecked,
   including the 10 September direct recheck of `ca-civ-code-1798-150`. The
   remaining 2 are listed in section 4. Then widen the recheck beyond the
   figures: 284 of 299 sources
