...
| Sources ever re-checked | **20 of 299.** All eleven figure-source documents are re-read, plus three high-impact California evidence sources; 279 sources remain first-read only |
...
2. **A published recheck cadence.** 279 of 299 sources have
...
3. **Finish the figure-source recheck.** Needs a session that can reach the
   ...
   `ca-cdi-commercial-insurance-guide`, and `cfp-dwelling-policy`. 279 of 299 sources
