...
| Sources ever re-checked | **16 of 299.** Ten figure-source documents are now re-read; one of the eleven figure-source documents remains first-read only |
...
2. **A published recheck cadence.** 283 of 299 sources have
   ...
   overstate itself. One dated-figure source remains in the first-read queue.
...
3. **Finish the figure-source recheck.** Needs a session that can reach the
   documents; see the egress note in section 4. 10 of 11 are now rechecked,
   including the 10 September direct recheck of `cfr-49-387-303-lii`. The
   remaining 1 is listed in section 4. Then widen the recheck beyond the
   figures: 283 of 299 sources
