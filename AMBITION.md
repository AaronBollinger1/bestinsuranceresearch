...
| 3 | **Recheck the remaining figure sources** | Nothing | Next, and the next pass. Nine of eleven figure-source documents are now rechecked; two remain. See below. |
...
**15 of 299**: 284 sources carry the date somebody first read them and nothing
...
11 distinct source documents; nine are now rechecked and two remain
