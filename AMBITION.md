...
| 3 | **Recheck the remaining figure sources** | Nothing | Next, and the next pass. Eight of eleven figure-source documents are now rechecked; three remain. See below. |
...
**14 of 299**: 285 sources carry the date somebody first read them and nothing
...
11 distinct source documents; eight are now rechecked and three remain
